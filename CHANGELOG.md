...
### Changed
- Removed app sandbox — fixes the App Management permission prompt in System Settings.

## [1.4.4] - 2026-04-27

### Changed
- Account settings now shows trial status with days remaining and an upgrade button, or subscription active for paying subscribers.

## [1.4.3] - 2026-04-27

### Fixed
- App icon now uses the proper Apple Icon Composer render with correct lighting and liquid glass effects.

## [1.4.2] - 2026-04-27

### Fixed
- App icon restored — was missing from the last two releases.

## [1.4.1] - 2026-04-26

### Fixed
- Check for Updates button now works correctly — the settings sheet closes first before Sparkle opens its update window.
